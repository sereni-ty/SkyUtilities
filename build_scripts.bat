...
@set PPF_SCRIPTS=%LIBS%\SKSE;%LIBS%\Skyrim;%LIBS%\SkyUI 5.1;%LIBS%\SkyUtilities;%LIBS%\SLSF 0_99;%LIBS%\PapyrusUtil 3_3_0_0;%LIBS%\SEXLAB_1_62;%LIBS%\FNIS 6_3;%LIBS%\FNIS Creature Pack 6_1;%LIBS%\RaceMenu 3_4_5
